...
def extractdata(frostcfg,station,stmd,output):
    ...
    #ds_station.variables['data'][0]['elementId'].attrs['standard_name'] = variables['data'][0]['elementId']
    #varname = variables['data'][1]['elementId']
    #print(varname)
    #ds_station[varname].attrs
    #ds_station.varname.attr
